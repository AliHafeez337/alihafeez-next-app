...
const SYNONYMS = {
  ...
  llm: ['gemini', 'groq', 'generative', 'chat', 'model', 'api'],
  chatbot: ['chat', 'portfolio', 'career', 'rag', 'gemini'],
  gemini: ['google', 'embedding', 'generative', 'api'],
  groq: ['llama', 'backup', 'llm'],
  ml: ['machine', 'learning', 'deep', 'nlp', 'neural'],
  nlp: ['natural', 'language', 'processing', 'text'],
  portfolio: ['website', 'next', 'chat', 'rag', 'career'],
  chat: ['portfolio', 'career', 'rag', 'gemini', 'api'],
};
